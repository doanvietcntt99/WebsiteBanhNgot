...
<html lang="en">
   ...
   <body class="">
                        ...
                        <div class="card">
                           <div class="card-header card-header-primary">
                              <div style="float:left">
                                 ...
                                 <p class="card-category">Để xem chi tiết loại bánh, vui lòng chọn vào
                                 </p>
                              </div>
                              <div style="float:right">
                                 <button type="button" class="btn btn-info btn-lg"
                                    data-toggle="modal" data-target="#ModelAddNewProduct">Thêm mới thể loại</button>
                              </div>
                           </div>
                           <div class="card-body">
                              <div class="table-responsive">
                                 <table class="table table-hover">
                                    ...
                                    <tbody>
                                       <tr th:each="productType :${categoryList.pageList}">
                                          <td th:text="${productType.productTypeId}">...</td>
                                          <td th:text="${productType.productTypeName}">...</td>
                                          <td th:text="${productType.createAt}">...</td>
                                          <td th:text="${productType.updateAt}">...</td>
                                          <td class="td-actions ">
                                             <button type="button" class="btn btn-primary btn-link btn-sm" title="Chi Tiết" data-toggle="modal" th:data-target="${'#ModelAddNewProduct'+productType.productTypeId}" >
                                             <i class="material-icons">edit
                                             </i>
                                             </button>
                                             <a th:href="@{/deleteProductType(productTypeId=${productType.productTypeId})}"
                                                type="button" rel="tooltip" title="Xóa"
                                                class="btn btn-danger btn-link btn-sm">
                                             <i class="material-icons">close</i>
                                             </a>
                                             <a th:switch="${productType.status}"
                                                th:href="@{/switchVisibleProductType(productTypeId=${productType.productTypeId})}"
                                                title="Ẩn/Hiện" type="button" rel="tooltip"
                              ...
                              <ul class="pagination">
                                 <li
                                    ...
                                    <a class="page-link" th:href="@{/viewListCategory}">Trang Đầu</a>
                                 </li>
                                 <li
                                    th:class="${currentIndex == 1}? 'page-item disabled': 'page-item' ">
         ...
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form th:action="@{/addNewProductType}" th:object="${productType}" method="POST"
                     >
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="bmd-label-floating">Tên Bánh</label>
                              <input type="text" class="form-control" th:field="*{productTypeName}">
                           </div>
                        </div>
                     </div>
               </div>
      ...
      <div th:each="productType1 :${categoryList.pageList}" class="modal fade" th:id="${'ModelAddNewProduct'+productType1.productTypeId}" role="dialog">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
               ...
               <div class="modal-body">
                  <form th:action="@{/updateProductType(productTypeId=${productType1.productTypeId})}" th:object="${productType}" method="POST"
                     >
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="bmd-label-floating">Tên Bánh</label>
                              <input type="text" class="form-control" th:value="${productType1.productTypeName}" th:field="*{productTypeName}">
                           </div>
                        </div>
                     </div>
               </div>
      ...
      <script src="http://localhost:8181/js/plugins/perfect-scrollbar.jquery.min.js"></script>
