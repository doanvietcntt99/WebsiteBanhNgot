                  ...
                  <div class="row">
                     <div class="col-md-8">
                        <div class="card">
                           ...
                           <div class="card-body">
                              <form th:action="@{/updateProfile}" th:object="${account}" method="POST">
                                 <div class="row">
                                    <div class="col-md-5">
                                       <div class="form-group">
                                          <label class="bmd-label-floating">ID</label>
                                          <input type="text" class="form-control"
                                             th:value="${account.idAccount}" th:field="*{idAccount}"
                                             disabled>
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control"
                                             th:value="${account.username}" th:field="*{username}" disabled>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          <label class="bmd-label-floating">Địa Chỉ Email</label>
                                          <input type="email" class="form-control" th:value="${account.email}"
                                             th:field="*{email}">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control"
                                             th:value="${account.fullname}" th:field="*{fullname}">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="bmd-label-floating">Số Điện Thoại</label>
                                          <input type="text" class="form-control" th:value="${account.phone}"
                                             th:field="*{phone}">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control"
                                             th:value="${account.address}" th:field="*{address}">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          <label class="bmd-label-floating">Tài khoản Telegram</label>
                                          <input type="text" class="form-control"
                                             th:value="${account.telegramUsername}"
                                             th:field="*{telegramUsername}">
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <input type="checkbox" class="form-control"
                                             th:value="${account.status}" th:field="*{status}">
                                       </div>
                                    </div>
                                 </div>
                     ...
                     <div class="col-md-4">
                        <div class="card card-profile">
                           <div class="card-avatar">
                              <a href="javascript:;">
                              <img class="img" th:src="@{${'/img/' + account.avatar}}" />
                              </a>
                           </div>
                           <div class="card-body">
                              <h6 class="card-category text-gray">Admin Page</h6>
                              <h4 class="card-title" th:text="${account.fullname}"></h4>
                              <form th:action="@{/user/saveAvatar}" th:object="${account}" method="post"
                                 enctype="multipart/form-data">
                                 <input class="form-control fade" th:value="${account.idAccount}"
