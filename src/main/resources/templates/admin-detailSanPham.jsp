      ...
      <div class="wrapper ">
         ...
         <div class="main-panel">
            ...
            <div class="container" style="margin-top: 100px">
               <center>
                  <asp:Label ID="lblNotice" runat="server" ForeColor="Green" Text=""></asp:Label>
               </center>
               <div class="row">
                  <div class="col-sm-4">
                     <h5>Photos</h5>
                     <div class="fakeimg text-center">
                        <img th:src="@{${'/img/' + product.productImage}}" alt="Avatar Admin" class="fakeimg" />
                        <form th:action="@{/product/saveAvatar}" th:object="${product}" method="post"
                           enctype="multipart/form-data">
                           <input class="form-control fade" th:value="${product.productId}" th:field="*{productId}"
                              type="text" />
                  ...
                  <div class="col-sm-8" style="margin-top: 80px;">
                     <form th:action="@{/updateProduct}" th:object="${product}" method="POST">
                        <div class="modal-body">
                           <table class="table">
                              <tr>
                                 <td class="cantrai">Mã Sản Phẩm </td>
                                 <td>
                                    <input class="form-control" th:value="${product.productId}"
                                       th:field="*{productId}" type="text" />
                                 </td>
                              </tr>
                              <tr>
                                 <td class="cantrai">Tên Sản Phẩm </td>
                                 <td>
                                    <input class="form-control " th:value="${product.productName}"
                              ...
                              <tr>
                                 <td class="cantrai">Số Lượng : </td>
                                 <td>
                                    <input class="form-control " th:value="${product.amount}"
                                       th:field="*{amount}" type="text" />
                                 </td>
                              </tr>
                              <tr>
                                 <td class="cantrai">Giá :</td>
                                 <td>
                                    <input class="form-control " th:value="${product.price}" th:field="*{price}"
                                       type="text" />
                                 </td>
                              </tr>
                           </table>
                        ...
                        <div class="modal-footer">
                           <input type="submit" value="Cập Nhật" class="btn btn-success" />
                           <input type="reset" value="Clear" CssClass="btn btn-secondary shadow-sm" />
                        </div>
                     </form>
                  </div>
               </div>
               <div class="container-fluid">
                  ...
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                     <h1 class="h3 mb-0 text-gray-800">Danh Sách Hình Ảnh</h1>
                     <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"
                        data-toggle="modal" data-target="#myModalImage">
                     <i class="fas fa-download fa-sm text-white-50"></i>Thêm Ảnh Cho Sản Phẩm
                     </button>
                  </div>
                  <table class="table table-hover">
                     ...
                     <tbody>
                        <tr th:each="productImage :${productImageList}">
                           <td scope="row" th:utext="${productImage.productImageId}">...</td>
                           <td>
                              <img th:src="@{${'/img/' + productImage.nameImage}}" width="300px"
                                 class="img-thumbnail img-fluid" />
                           </td>
                           <td>
                              <a th:switch="${productImage.status}"
                                 th:href="@{/switchVisibleProductImage(productImageId=${productImage.productImageId})}"
                                 title="Ẩn hình ảnh" type="button" rel="tooltip"
                                 class="btn btn-primary btn-link btn-sm">
                              <i th:case="${true}" class="material-icons">visibility</i>
                              <i th:case="${false}" class="material-icons">visibility_off</i>
                              </a>
                              <a th:href="@{/deleteProductImage(productImageId=${productImage.productImageId})}"
                                 type="button" rel="tooltip" title="Xóa" class="btn btn-danger btn-link btn-sm">
      ...
      <div class="modal fade" id="myModalImage">
         <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
               ...
               <!-- Modal body -->
               <form th:action="@{/product/productImages}" th:object="${product}" method="post"
                  enctype="multipart/form-data">
                  <div class="modal-body">
                     <table class="table">
                        <tr>
                           ...
                           <td style="float: right;">
                              <input type="text" name="avatar" th:value="${product.productId}"
                                 th:field="*{productId}" readonly="true" />
                           </td>
                        </tr>
                        <tr>
                           <td class="cantrai">Ảnh Đại Diện:</td>
                           <td style="float: right;">
                              <input type="file" name="image" class="form-control-file"
                                 accept="image/png, image/jpeg" />
                           </td>
                        </tr>
                        <input type="submit" text="Tạo" class="btn btn-primary">
