               ...
               <div class="col-lg-6">
                  <div class="card2 card border-0 px-4 py-5">
                     ...
                     <div class="row px-3">
                        ...
                        <input class="mb-4" th:field="*{username}" type="text" name="email" placeholder="Nhập tài khoản">
                     </div>
                     <div class="row px-3">
                        <label class="mb-1">
                           <h6 class="mb-0 text-sm">Password</h6>
                        </label>
                        <input type="password" th:field="*{password}" name="password" placeholder="Nhập mật khẩu">
                     </div>
                     <div class="row px-3 mb-4">
