                            ...
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <div style="float:left">
                                        ...
                                        <p class="card-category">Dưới đây là chi tiết các khách hàng đã thực hiện giao dịch với cửa hàng
                                        </p>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr th:each="view_guest :${orderListTotal}">
                                                    <td th:utext="${view_guest.fullNameGuest}">...</td>
                                                    <td th:utext="${view_guest.addressGuest}">...</td>
                                                    <td th:utext="${view_guest.phoneGuest}">...</td>
                                                    <td th:utext="${view_guest.TotalProduct}">...</td>
                                                    <td class="text-primary" th:utext="${view_guest.totalPrice}">...</td>
