...
//    private static final String Email_Receive_Address = "boykutenolove2199@gmail.com";
    ...
    public static void SendEmailPaypalSuccessFul(Order order) {
        ...
        try {
            ...
            message.setSubject("Thực hiện thanh toán thành công trên cổng thanh toán Paypal");
            message.setText("Dear Khách Hàng " + order.getFullNameGuest()
                    + "\n\n Đơn hàng dưới đây đã được thanh toán thành công trên cổng thanh toán trực tuyến Paypal!"
                    + "\n\n Chi tiết đơn hàng : \n " +
                    "+ Mã đơn hàng : " + order.getOrderId() + "\n" +
                    "+ Người đặt hàng: " + order.getFullNameGuest() + "\n" +
                    "+ Số Điện Thoại: " + order.getPhoneGuest() + "\n" +
