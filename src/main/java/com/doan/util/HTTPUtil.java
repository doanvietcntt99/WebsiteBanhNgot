...
public class HTTPUtil {
    ...
    public static final String HTTP_URL_POST_PAYMENT = "http://localhost:8181/pay";

    public void GetRequestPaypal(double price, String HTTP_URL) throws IOException {
        String urlAddress = HTTP_URL + "?price=" + price;
