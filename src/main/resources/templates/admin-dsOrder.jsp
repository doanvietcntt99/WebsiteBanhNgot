                        ...
                        <div class="card">
                           <div class="card-header card-header-primary">
                              <div style="float:left">
                                 ...
                                 <p class="card-category">Để xem chi tiết đơn hàng, vui lòng chọn vào phần xem chi tiết
                                 </p>
                              </div>
                           </div>
                           <div class="card-body">
                                 ...
                                 <table class="table table-hover">
                                    ...
                                    <tbody>
                                       <tr th:each="order :${orderList.pageList}">
                                          ...
                                          <td th:utext="${order.fullNameGuest}">...</td>
                                          <td th:utext="${order.orderDate}">...</td>
                                          <td th:utext="${order.phoneGuest}">...</td>
                                          <td class="text-primary" th:utext="${order.totalPrice}">...</td>
                                          <td th:switch="${order.hasBeenPay}">
                                             <input class="form-control"th:case="${true}" type="checkbox" checked="checked" th:value="${order.hasBeenPay}" disabled />
                                             <input class="form-control"th:case="${false}" type="checkbox" th:value="${order.hasBeenPay}"  disabled/>
                                          </td>
                                          <td class="td-actions ">
                                             <a th:href="@{/editProduct(orderId=${order.orderId})}"
                                                type="button" rel="tooltip" title="Chi Tiết"
                                                class="btn btn-primary btn-link btn-sm">
                                             <i class="material-icons">edit</i>
                                             </a>
                                             <a th:href="@{/deleteOrder(orderId=${order.orderId})}"
                                                type="button" rel="tooltip" title="Xóa"
                                                class="btn btn-danger btn-link btn-sm">
                                             <i class="material-icons">close</i>
                                             </a>
                                             <a th:switch="${order.hasBeenPay}"
                                                th:href="@{/switchHasbeenPay(orderId=${order.orderId})}"
                                                title="Thanh Toán" type="button" rel="tooltip"
                                                class="btn btn-primary btn-link btn-sm">
                              ...
                              <ul class="pagination">
                                 <li
                                    ...
                                    <a class="page-link" th:href="@{/viewListOrder}">Trang Đầu</a>
                                 </li>
                                 <li
                                    th:class="${currentIndex == 1}? 'page-item disabled': 'page-item' ">
            ...
            <footer class="footer">
               <div class="container-fluid">
                  ...
                  <div class="copyright float-right">
                     ...
                     <a href="https://www.facebook.com/doanvietcntt99/" target="_blank">Đinh Doãn Việt</a>.
                  </div>
               </div>
            </footer>
         </div>
